...
docker run -i --rm --init --privileged --ulimit nofile=65536:65536 --ulimit core=-1 $DOCKER_TARGET_IMAGE_TPCH bash -c "java -Xmx2G -cp /opt/gluten-it/target/gluten-it-1.0-SNAPSHOT-jar-with-dependencies.jar io.glutenproject.integration.tpc.h.Tpch $CMD_ARGS"
