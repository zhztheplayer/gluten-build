...
# Script uses "test -n ENABLE_DEBUG_BUILD" to determine if debug build is enabled
if [ "$DEBUG_BUILD" == "ON" ]
then
  ENABLE_DEBUG_BUILD=enabled
fi
...
EXEC_ARGS="$EXEC_ARGS --build-arg ENABLE_DEBUG_BUILD=$ENABLE_DEBUG_BUILD"
