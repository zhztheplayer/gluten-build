...
# The test suites should be run after build
VELOX_SUITE=${VELOX_SUITE:-$DEFAULT_VELOX_SUITE}
GLUTEN_CPP_SUITE=${GLUTEN_CPP_SUITE:-$DEFAULT_GLUTEN_CPP_SUITE}
...
DOCKER_TARGET_IMAGE=${DOCKER_TARGET_IMAGE:-$DEFAULT_DOCKER_TARGET_IMAGE}
